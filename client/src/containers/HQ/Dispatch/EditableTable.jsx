...
class EditableTable extends React.PureComponent {
  ...
  handleSave = (row) => {
    ...
    const calcNewData = newData.map(item => ({
      ...item,
      dispatchGoodsAmount: item.dispatchGoodsCount * item.unitPrice,
      dispatchGoodsDiffCount: item.goodsCount - item.dispatchGoodsCount,
      dispatchGoodsDiffAmount: (item.goodsCount - item.dispatchGoodsCount) * item.unitPrice,
    }));
